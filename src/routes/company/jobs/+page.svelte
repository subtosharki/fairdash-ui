...
<body class="bg-base-200 p-8">
	<div class="container mx-auto bg-base-100 p-6 rounded shadow-lg">
		...
		<p class="text-2xl font-bold mb-6">
			We're looking for talented individuals to join our team and help us build the future of food
			delivery. If you're passionate about technology and want to make a difference, apply today.
		</p>
		...
		<div class="mb-6">
			...
			<ul class="list-disc ml-6">
				<li>Developing and maintaining web applications using Svelte</li>
				<li>Collaborating with the design team to create a seamless user experience</li>
				<li>Working on front-end features and optimizing performance</li>
			</ul>
		</div>
		...
		<div class="mb-6">
			<h2 class="text-lg font-semibold">Support Team Members</h2>
			<p>
				Our support team is expanding, and we're searching for dedicated individuals to assist our
				users and ensure their satisfaction. If you're a problem-solver and great communicator,
				apply today. Responsibilities include:
			</p>
			<ul class="list-disc ml-6">
				<li>
					Responding to user inquiries and providing assistance through email, chat, and phone
				</li>
				<li>Troubleshooting and resolving user issues with empathy and efficiency</li>
				<li>Collaborating with the development team to address technical concerns</li>
			</ul>
		</div>
		...
		<div class="mb-6">
			...
			<ul class="list-disc ml-6">
				<li>Creating and implementing marketing strategies to acquire and retain users</li>
				<li>Managing social media accounts and engaging with our online community</li>
				<li>Measuring and analyzing campaign performance to optimize strategies</li>
			</ul>
		</div>
		...
		<div class="mb-6">
			...
			<ul class="list-disc ml-6">
				<li>Managing and growing our online community through social media and other channels</li>
				<li>Organizing community events, contests, and engagement initiatives</li>
				<li>Listening to user feedback and addressing community concerns</li>
			</ul>
		</div>
		...
		<div class="mb-6">
			...
			<ul class="list-disc ml-6">
				...
				<li>Maintaining a consistent and attractive visual style for the platform</li>
			</ul>
		</div>
