	...
	const terms = [
		{
			...
			body: 'By using FairDash, you affirm that you are of legal age and have the capacity to enter into this Agreement. You agree to comply with all applicable laws and regulations while using FairDash.'
		},
		{
			title: 'User Accounts',
		...
		},
		{
			...
			body: 'FairDash and its content, including logos, trademarks, and software, are protected by intellectual property laws. You may not use or reproduce them without prior written consent.'
		},
		{
			title: 'User Content',
		...
		{
			title: 'Privacy',
			body: "FairDash's privacy practices are outlined in our Privacy Policy, which is an integral part of this Agreement."
		},
		{
		...
		{
			title: 'Termination',
			body: 'FairDash reserves the right to terminate or suspend your access to the platform at any time without notice.'
		},
		{
			title: 'Changes to Terms',
			body: 'FairDash may update these terms at any time, and such changes will be effective upon posting on the platform. It is your responsibility to review the terms periodically to stay informed of any updates.'
		},
		{
			title: 'Governing Law',
