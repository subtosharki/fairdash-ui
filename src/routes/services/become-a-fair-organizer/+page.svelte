...
<div class="min-h-screen flex items-center justify-center bg-base-200">
	<div class="w-full max-w-screen-xl md:grid md:grid-cols-2 md:gap-8 p-4">
		<div class="p-6 bg-base-100 rounded-lg shadow-md mb-4 md:mb-0">
			...
			<div class="mb-6">
				...
				<ol class="list-decimal list-inside pl-5">
					...
					<li class="mb-2">
						Real-Time Control: Easily manage vendor registrations, RV spot assignments, and fair
						information in real-time. Make updates and adjustments as needed, ensuring your fair
						runs smoothly.
					</li>
					<li class="mb-2">
						Hassle-Free Vendor Management: Vendors have full control over their menus, simplifying
						coordination. Vendors can easily set up their offerings, making it a breeze for them to
						participate.
					</li>
					<li class="mb-2">
						Secure Payment Processing: We've integrated Stripe for secure and reliable payment
						transactions. Fairgoers and vendors can make payments with confidence, ensuring smooth
					...
					<li class="mb-2">
						Customizable Fair Events: Tailor your fair events to your specific needs. Create unique
		...
		<RegisterForm
			asOrganizer={true}
			title="Signup as a Fair Organizer"
